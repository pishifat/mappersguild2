...
/* POST add criteria */
adminContestsRouter.post('/:id/addCriteria', async (req, res) => {
...
/* POST add criteria */
adminContestsRouter.post('/:id/deleteCriteria', async (req, res) => {
...
adminContestsRouter.get('/:id/judgingResults', async (req, res) => {

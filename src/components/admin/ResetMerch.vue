<template>
    <div class="container card card-body py-3 mb-2">
        ...
        <div class="mb-2">
            <div class="row">
                <div class="col-sm-6">
                    <select v-model="field" class="form-select form-select-sm">
                        <option
                            disabled
                            value=""
                        >
            ...
            <button :disabled="!field.length" class="btn btn-sm btn-info w-25 me-2" @click="loadUsers($event)">
                Load users
            </button>
            <button :disabled="!field.length" class="btn btn-sm btn-danger w-25" @click="reset($event)">
                Reset
            </button>

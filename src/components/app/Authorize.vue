<template>
    <section key="login" class="card card-body mt-4">
        <div class="row">
            <div class="col-lg-5">
            ...
            <div class="col-lg-7 d-flex flex-column justify-content-center">
                ...
                <ul>
                    <!--<li>Use <a href="https://osu.ppy.sh/home/news/2026-06-14-aspire-6">Aspire 6</a>'s team finder</li>-->

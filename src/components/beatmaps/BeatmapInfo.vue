    ...
    <div class="row">
            ...
            <div class="row mb-3" v-if="isHost">
                <div class="col">
                    <div id="mode" class="form-group" v-if="beatmap.status == 'WIP'">
                        ...
                        <button
                            class="btn btn-sm btn-info rounded-100 text-dark"
                        ...
                        <button
                            class="btn btn-sm btn-info rounded-pill text-dark"
                    ...
                    <div class="form-group" v-if="isEditable" id="mapsetStatus">
                        <div class="d-inline-block mr-2">
                            Status
                        </div>
                        <button
        ...
        <div class="col-sm-5 bm-col-separator-left">
                ...
                <div class="col">
                    <div>
                        ...
                        >
                            <a
                                href="#"
                                v-if="isModder && !isHost && isEditable"
            ...
            <div class="row mt-4 float-right">
                <span class="small mt-1 text-white-50">
...
export default {
    ...
    computed: {
        ...
        isEditable: function() {
            return this.beatmap.status == 'WIP' || this.beatmap.status == 'Done';
        },
        isModder: function() {
            let value;

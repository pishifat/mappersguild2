<template>
    <div class="row">
        ...
        <div v-if="!mission.isShowcaseMission || (mission.isShowcaseMission && mission.artists && mission.artists.length)" class="col-sm-12 small">
            ...
            <span v-else-if="mission.isOsuOriginal" class="ms-1">Any <a href="https://osu.ppy.sh/wiki/Community/Bespoke_music">osu! original</a> (labeled with <img src="https://osu.ppy.sh/wiki/images/shared/link/original-pill.png" style="vertical-align: -3px;" />) in the <a href="https://osu.ppy.sh/beatmaps/artists" target="_blank">Featured Artist listing</a>. Check the <b>objective</b> above for any exceptions.</span>
            <span v-else class="text-secondary ms-1">Any, pending quest requirements. See the <a href="https://osu.ppy.sh/beatmaps/artists" target="_blank">full Featured Artist listing</a>.</span>
